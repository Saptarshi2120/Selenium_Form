...
my_email1 = "tech@themedius.ai"
password = "deel tsxs omxc zdpg"

# Create the email
msg = MIMEMultipart()
msg['From'] = my_email
msg['To'] = "tech@themedius.ai, saptarshideyed123@gmail.com"
...
body = """
    ...
    4. Resume: Attached as Saptarshi's CV.pdf.
...
# Attachments
attachments = ["screenshot_1.png","screenshot_2.png","screenshot_3.png", "Saptarshi's CV.pdf", "Selenium Automation Script Documentation.pdf"]
...
# Combine recipients and CC for the sendmail method
